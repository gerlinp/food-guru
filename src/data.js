...
const REVIEWS_DEFAULT = [
  { id:'totto-ramen', name:'Totto Ramen', cuisine:'Japanese Ramen', city:'Somerville, MA', neighborhood:'Assembly Row', lat:42.3941, lng:-71.0773, rating:4.8, price:'$$', author:'Guru', date:'May 21, 2026', headline:'The bowl I keep coming back to, even from Providence.', excerpt:"My favorite ramen in the Greater Boston area — and it has been for years. The Paitan broth is rich, consistent, and deeply satisfying. Assembly Row makes the whole trip easy.", tint:'t3', standout:'Paitan Ramen', photo:'images/reviews/totto-ramen/storefront.webp', photos:[{src:'images/reviews/totto-ramen/paitan.webp',caption:'Paitan Ramen'},{src:'images/reviews/totto-ramen/takoyaki.webp',caption:'Takoyaki'},{src:'images/reviews/totto-ramen/onigiri.webp',caption:'Onigiri'}], body:["Totto Ramen is my favorite ramen spot in the Greater Boston area. Even though I live in Providence now, it is still the first place I think of when I'm craving ramen. The location is at Assembly Row, right next to a three-hour free parking garage, which makes it an easy spot to get to without having to stress too much about parking.","My go-to order is the signature Paitan Ramen. It comes with your choice of chicken or pork slices, along with shredded pork, scallions, onion, and noodles in a savory chicken broth. I've had almost everything they offer at this point, but the Paitan is the bowl I keep coming back to. The broth is rich and comforting, the noodles hold up well, and the whole bowl is just really satisfying.","For appetizers, I recommend the takoyaki and/or the onigiri. The takoyaki is Japanese-style fried octopus cakes with mayo, kagome sauce, fish flakes, and pickled ginger. The onigiri is a rice ball stuffed with pulled pork, chicken, or tuna and wrapped in seaweed. It is super simple, but done really well.","What I like most about Totto is how consistent it is. I have tried a lot of the menu, and even though I have my usual order, I never feel like the rest of the menu is weak. It is one of those places that does not need to do too much because the ramen speaks for itself.","Another great thing about this location is that you can take a walk before or after your meal along the river and get a nice view of Encore Casino. Assembly Row itself is also a great spot to make a whole outing out of since the shopping center has a movie theater, plenty of stores, and a lot of other restaurants nearby. Between the food, the location, and how easy it is to spend time there, Totto Ramen is always the place I recommend when someone asks me where to get ramen around Boston."] },
